<template>
    <div class="my-footer-container">
            ...
            <div>
                <h3> </h3>
                    <ul>
                        <li>
                            <div class="mysvg">
                                <a href="https://weibo.com/airbnb?is_hot=1#_loginLayer_1563148840671">
                                    <svg viewBox="0 0 32 32" role="img" aria-label="前往微博" focusable="false" style="height: 18px; width: 18px; display: block; fill: rgb(118, 118, 118);">
                                ...
                                <div class="mysvg">
                                    <svg viewBox="0 0 32 32" role="presentation" aria-hidden="true" focusable="false" style="height: 1em; width: 1em; display: block; fill: currentcolor;">
        ...
        <!-- 底部文字 -->
        <div class="my-footer-last">
            <div class="inlineblock mywid1">
                    <svg viewBox="0 0 1000 1000" role="presentation" aria-hidden="true" focusable="false" style="height: 20px; width: 20px; display: inline-block; fill: rgb(118, 118, 118);">
            ...
            <div class="inlineblock mywid2">
                <div>
                    <span>京ICP备16017121号-3 京ICP证 160773号</span>
                    <img src="http://127.0.0.1:3000/img/img-index/guohui.png" alt="">
